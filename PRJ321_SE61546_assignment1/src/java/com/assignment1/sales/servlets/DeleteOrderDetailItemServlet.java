    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                result = dao.deleteOrderDetailsByOrderDetailId(id, orderID, loginUser);
                ...
                errorObj.setOnlyOneDetailForOrder("COULD NOT DELETE THIS DETAIL BECAUSE "
                    + "THERE IS NO MORE ORDER DETAIL FOR THIS ORDER! Try to go back and delete the order instead.");
